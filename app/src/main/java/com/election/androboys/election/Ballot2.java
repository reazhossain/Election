...
public class Ballot2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ballot2);



        b1 = (Button)findViewById(R.id.buttonreBasar);
        b2 = (Button)findViewById(R.id.buttonNazim);
        b3 = (Button)findViewById(R.id.buttonKorim);
        b4 = (Button)findViewById(R.id.buttonKamrun);
